    ...
    <div className="page-pad">
      ...
      {step==="plans"&&(
        <div style={{padding:"0 17px"}}>
          ...
          <div style={{fontSize:11,color:"var(--sub)",textAlign:"center",marginTop:8}}>Cancel anytime · No hidden fees</div>
        </div>
      )}
    ...
    <div className="auth">
      ...
      <div className="auth-scroll">
        ...
        {step===2&&<>
          ...
          <div style={{fontSize:11,color:"rgba(254,252,247,0.3)",lineHeight:1.6,marginBottom:12}}>By signing up you agree to our Terms and Privacy Policy.</div>
        </>}
        ...
        {tab==="profile"&&(
          <div className="page-pad">
            ...
            <div className="settings-section">
              ...
              {[["📝","Edit Profile",()=>setEditProfileOpen(true)],["🌍","Change City",()=>setEditProfileOpen(true)],["✈️","Join Telegram Community",()=>{markTelegramJoined();window.open(TELEGRAM_URL,"_blank");}],["📤","Share Xairod",()=>{}],["💬","Send Feedback",()=>{}],["⭐","Rate the App",()=>{}]].map(([ic,lb,action],i)=>(
